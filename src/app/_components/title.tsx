...
const Title = () => {
    return(
        <section id="#" className="">
            <div className="relative flex items-end pb-16 justify-end flex-col pt-16 bg-bottom bg-no-repeat bg-[url('/oday.jpg')] bg-cover h-[100vh] overflow-hidden bg-[#202a44]/40 bg-blend-multiply">
