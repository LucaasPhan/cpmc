    ...
    return(
        <section id="motto">
            <Animator animation={batch(Fade(), MoveOut(0, -200))}>
                <div className="flex flex-col h-[100vh] items-center justify-center align-middle px-[5%] xl:px-[10%] 2xl:px-[20%] bg-center bg-no-repeat bg-[url('/about3.jpg')] bg-cover overflow-hidden bg-purple-950/45 bg-blend-multiply">
