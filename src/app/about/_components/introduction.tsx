                ...
                <div className="flex flex-col h-[100vh] items-center justify-center align-middle px-[5%] xl:px-[10%] 2xl:px-[20%]">
                    <div className="flex items-center justify-around flex-col gap-4">
                        <div className="flex flex-col items-center lg:px-40 pb-10 gap-y-5">
                            <h1 className={`${font} text-left lg:text-center leading-[1.1] font-bold text-[44px] lg:text-5xl w-full drop-shadow-xl`}><span className="text-span">Central Park Media Crew </span> là gì?</h1>
