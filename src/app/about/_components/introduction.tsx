...
const Introduction = () => {
    return (
        <section id="#introduce">
            <div className="flex container items-center justify-around flex-col py-10 gap-4">
                <div className="flex flex-col items-center lg:px-40 md:pt-24 pb-10 gap-y-5">
                    <h1 className={`${raleway.className} text-center leading-[1.1] font-bold text-[44px] lg:text-5xl w-full drop-shadow-xl`}><span className="text-span">Central Park Media Crew </span> là gì?</h1>
